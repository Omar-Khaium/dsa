export 'data/repositories/arrays_impl.dart';
export 'data/datasources/remote.dart';
export 'data/datasources/remote_impl.dart';

export 'data/models/arrays.dart';

export 'domain/entities/arrays.dart';
export 'domain/repositories/arrays.dart';
...
export 'presentation/pages/arrays.dart';
